...
call :ExecuteCmd nuget.exe restore -packagesavemode nuspec "%DEPLOYMENT_SOURCE%\Warbler.sln"
IF !ERRORLEVEL! NEQ 0 goto error
...
:: 2. Build
call :ExecuteCmd "%MSBUILD_PATH%" "%DEPLOYMENT_SOURCE%\Warbler.sln" /nologo /verbosity:m /p:AutoParameterizationWebConfigConnectionStrings=false;Configuration=Release;UseSharedCompilation=false %SCM_BUILD_ARGS%
IF !ERRORLEVEL! NEQ 0 goto error
